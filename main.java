...
public class Main {
    ...
    public static void selectionSort(List<Integer> list)
    {
        ...
        System.out.printf("Selection Sort execution time: %-10dms with %d amount of swaps.%n", executionTime, swaps);
    ...
    public static void bubbleSort(List<Integer> list)
    {
        ...
        System.out.printf("Bubble Sort execution time:    %-10dms with %d amount of swaps.%n", executionTime, swaps);
